...
public class EditUkuranHewanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nama = (EditText) findViewById(R.id.edit_nama_ukuran);
        edit = (Button) findViewById(R.id.ukuran_ubah);
        nama.setText(getIntent().getStringExtra("Unama"));
    ...
    private void edit(final String nama){
        final String url = "http://renzvin.com/kouvee/api/UkuranHewan/update/";
        ...
        StringRequest post = new StringRequest(Request.Method.POST, url,
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(EditUkuranHewanActivity.this,"Gagal Mengubah Data Ukuran",Toast.LENGTH_SHORT).show();
            }
        })
        {
            @Override
            protected Map<String, String> getParams() {
                ...
                params.put("id",getIntent().getStringExtra("Uid"));
