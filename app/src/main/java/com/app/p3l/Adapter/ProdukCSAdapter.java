...
public class ProdukCSAdapter extends RecyclerView.Adapter<ProdukCSAdapter.ProdukView> {
    ...
    public ProdukCSAdapter(Context applicationContext, List<ProdukDAO> produk) {
        this.produk = produk;
    }
    ...
    public ProdukView onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_cs_produk,parent,false);
